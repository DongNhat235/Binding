...
SELECT StudentId, FullName, Age, Major FROM Students WHERE (StudentId = @StudentId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT StudentId, FullName, Age, Major FROM dbo.Students";
        ...
        public virtual int FillBy(SchoolDBDataSet.StudentsDataTable dataTable) {
